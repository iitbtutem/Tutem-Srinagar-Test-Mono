...
import { ActivityIndicator, KeyboardAvoidingView, Platform, ScrollView, TextInput, TextInputKeyPressEvent, View } from 'react-native';
...
export default function OtpScreen() {
  ...
  return (
    ...
    >
      <ScrollView
        contentContainerStyle={{ flexGrow: 1, paddingHorizontal: 16, paddingVertical: 40, gap: 12 }}
      ...
      >
        ...
        <View className="my-6 w-full flex-row gap-2">
          {inputArr.map((_, idx) => (
            <Input
              ...
              className="h-14 w-12 border-0 border-black dark:border-white bg-gray-100 text-center focus:border-2"
              value={inputArr[idx]}
              editable={!loading}
        ...
        {/* Navigation Buttons */}
        <View style={{ marginTop: 'auto', flexDirection: 'row', justifyContent: 'space-between', paddingTop: 24 }}>
          <Button
