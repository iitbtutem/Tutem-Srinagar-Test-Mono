...
function SelectValue({
  ...
  return (
    <SelectPrimitive.Value
      ref={ref}
      className={cn(
        'text-md line-clamp-1 flex flex-row items-center gap-2 text-foreground',
...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ref={ref}
      className={cn(
        'flex h-12 flex-row items-center justify-between gap-2 rounded-md border-primary bg-muted-foreground/10 px-3 py-2 shadow-sm shadow-black/5 dark:border-foreground/60 dark:bg-input/80 sm:h-9',
        Platform.select({
